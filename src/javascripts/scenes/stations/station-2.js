...
const makeStation2Scene = () => {
  const stationSceneTimeline = new TimelineLite()
    .add([
      // show station
      TweenMax.fromTo('#station-2', params.duration, { // show station duration
        // styles before
        x: document.getElementById('station-2').offsetWidth,
        display: 'block',
      }, {
        // styles afrer
        x: -document.getElementById('station-2').offsetWidth,
      ...
      // 9-8 card hide
      TweenMax.to('.station-2-scene-photo-9', params.cardhideSpeed, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
        delay: 0 * params.interval + params.start + params.show,
      }),
      TweenMax.to('.station-2-scene-photo-8', params.cardhideSpeed, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
        delay: 0 * params.interval + params.start + params.show,
      ...
      // 4-6 card show
      TweenMax.fromTo('.station-2-scene-photo-1', params.cardshowSpeed,
        {
          x: '100vw',
          y: '-120vh',
          ease: Linear.easeNone,
      ...
      TweenMax.fromTo('.station-2-scene-photo-4', params.cardshowSpeed,
        {
          x: '100vw',
          y: '120vh',
          ease: Linear.easeNone,
      ...
      // 4-6 card hide
      TweenMax.to('.station-2-scene-photo-1', params.cardhideSpeed, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
        delay: 1 * params.interval + params.start + params.show,
      }),
      TweenMax.to('.station-2-scene-photo-4', params.cardhideSpeed, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
        delay: 1 * params.interval + params.start + params.show,
      ...
      // 1-2 card hide
      TweenMax.to('.station-2-scene-photo-2', params.cardhideSpeed, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
        delay: 2 * params.interval + params.start + params.show,
      }),
      TweenMax.to('.station-2-scene-photo-3', params.cardhideSpeed, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
        delay: 2 * params.interval + params.start + params.show,
      ...
      // 5-3 card hide
      TweenMax.to('.station-2-scene-photo-5', params.cardhideSpeed, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
        delay: 3 * params.interval + params.start + params.show,
      }),
      TweenMax.to('.station-2-scene-photo-6', params.cardhideSpeed, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
        delay: 3 * params.interval + params.start + params.show,
      ...
      // 7 card show
      TweenMax.fromTo('.station-2-scene-photo-7', params.cardshowSpeed,
        {
          x: '-100vw',
          y: '200vh',
          ease: Linear.easeNone,
      ...
      // 7 card hide
      TweenMax.to('.station-2-scene-photo-7', params.cardhideSpeed, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
